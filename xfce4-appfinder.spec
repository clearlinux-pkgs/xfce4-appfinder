...
Source0  : http://archive.xfce.org/src/xfce/xfce4-appfinder/4.15/xfce4-appfinder-4.15.1.tar.bz2
...
%prep
%setup -q -n xfce4-appfinder-4.15.1
cd %{_builddir}/xfce4-appfinder-4.15.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1598025586
...
cp %{_builddir}/xfce4-appfinder-4.15.1/COPYING %{buildroot}/usr/share/package-licenses/xfce4-appfinder/dfac199a7539a404407098a2541b9482279f690d
%make_install
