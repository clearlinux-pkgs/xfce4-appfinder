...
Source0  : https://archive.xfce.org/src/xfce/xfce4-appfinder/4.16/xfce4-appfinder-4.16.1.tar.bz2
...
%prep
%setup -q -n xfce4-appfinder-4.16.1
cd %{_builddir}/xfce4-appfinder-4.16.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611001329
...
cp %{_builddir}/xfce4-appfinder-4.16.1/COPYING %{buildroot}/usr/share/package-licenses/xfce4-appfinder/dfac199a7539a404407098a2541b9482279f690d
%make_install
