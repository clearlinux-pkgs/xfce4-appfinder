...
Source0  : http://archive.xfce.org/src/xfce/xfce4-appfinder/4.13/xfce4-appfinder-4.13.5.tar.bz2
...
%prep
%setup -q -n xfce4-appfinder-4.13.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1564420143
