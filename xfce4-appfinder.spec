...
Source0  : http://archive.xfce.org/src/xfce/xfce4-appfinder/4.14/xfce4-appfinder-4.14.0.tar.bz2
...
%prep
%setup -q -n xfce4-appfinder-4.14.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1565572304
